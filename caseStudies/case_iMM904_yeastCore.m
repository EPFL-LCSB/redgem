function [OriginalGEM, GEMmodel, core_ss, Biomass_rxns, met_pairs_to_remove, InorgMetSEEDIDs, BBBsToExclude, ExtraCellSubsystem] = case_iMM904_yeastCore(ZeroZeroGEMbounds, FluxUnits, ListForInorganicMets, ListForCofactorPairs, SelectedSubsystems, AddExtracellularSubsystem, DB_AlbertyUpdate)

% Model Specific Settings:
fprintf('Loading the GEM for YeastCore iMM904 ...\n')
GEM_filename = 'iMM904_yeastCore.mat';
GetModelFromGITresources(GEM_filename)
GEMmodel = load(['./GEMs/',GEM_filename]);
GEMmodel = GEMmodel.iMM_yeastCore;
...
GEMmodel = prepModelforTFBA(GEMmodel,DB_AlbertyUpdate,GEMmodel.CompartmentData, false, false);
