function [GEMmodel,core_ss,Biomass_rxns,met_pairs_to_remove,InorgMetSEEDIDs] = case_Glycolysis(ZeroZeroGEMbounds,FluxUnits,ListForInorganicMets,ListForCofactorPairs)

% Model Specific Settings:
fprintf('Loading the GEM for E. Coli...\n')
GEMmodel = load('./GEMs/GSmodel_Ecoli.mat');
