function [OriginalGEM, GEMmodel, core_ss, Biomass_rxns, met_pairs_to_remove, InorgMetSEEDIDs, BBBsToExclude, ExtraCellSubsystem] = case_ecoli_iAF1260(ZeroZeroGEMbounds, FluxUnits, ListForInorganicMets, ListForCofactorPairs, SelectedSubsystems, AddExtracellularSubsystem, DB_AlbertyUpdate)

% Model Specific Settings:
fprintf('Loading the GEM for E. Coli...\n')
GEM_filename = 'iAF1260_BasedOn_Klamt.mat';
GEM_fullpath = GetModelFromGITresources(GEM_filename)
GEMmodel = load(GEM_fullpath);
GEMmodel = GEMmodel.iAF1260_BasedOn_Klamt;
...
Biomass_rxns = {'Ec_biomass_iAF1260_core_59p81M'}
ObjRxn = {'Ec_biomass_iAF1260_core_59p81M'};
