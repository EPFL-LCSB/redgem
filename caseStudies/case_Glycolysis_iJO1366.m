function [OriginalGEM, GEMmodel, core_ss, Biomass_rxns, met_pairs_to_remove, InorgMetSEEDIDs, BBBsToExclude] = case_Glycolysis_iJO1366(ZeroZeroGEMbounds,FluxUnits,ListForInorganicMets,ListForCofactorPairs,DB_AlbertyUpdate)
...
core_ss = {'Glycolysis/Gluconeogenesis'};
